    ...
    const apiResponse = await fetch("https://openrouter.ai/api/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            // GA CANJIN DA AKA YI A NAN:
            content: `You are an expert multi-lingual translator. Your task is to:
1. Automatically detect the language of the user's text.
2. Correct any spelling mistakes, typos, or grammatical errors in the original text to capture the intended meaning.
3. Translate the corrected text into the target language: ${targetLang}.
4. Maintain the original formatting (like line breaks and paragraphs).
If the text is already in the target language, just correct any errors and return the corrected text.`
          },
